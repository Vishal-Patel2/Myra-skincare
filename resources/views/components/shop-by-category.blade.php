...
<section class="bg py-5">
    <div class="container">
        ...
        <ul class="nav nav-pills justify-content-center mb-4" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active"
                    id="{{ $categorySlug }}-female-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#{{ $categorySlug }}-female"
                    type="button"
                    role="tab"
                    aria-selected="true"
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link"
                    id="{{ $categorySlug }}-male-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#{{ $categorySlug }}-male"
                    type="button"
                    role="tab"
                    aria-selected="false"
                    tabindex="-1"
        ...
        <div class="tab-content">
            ...
            <!-- Male Tab -->
            <div class="tab-pane fade" id="{{ $categorySlug }}-male" role="tabpanel" aria-labelledby="{{ $categorySlug }}-male-tab">
                <div class="row">
