                                    ...
                                    <tbody>
                                        @forelse ($doctors as $doctor)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($doctor->image)
                                                        <img src="{{ asset('storage/doctors/' . $doctor->image) }}" height="60" alt="Doctor Image">
                                                    @else
                                                ...
                                                <td class="d-flex gap-2">
                                                    <a href="{{ route('doctor_details.edit', $doctor->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                    <form action="{{ route('doctor_details.destroy', $doctor->id) }}" method="POST"
