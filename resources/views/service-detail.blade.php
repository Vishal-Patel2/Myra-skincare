                        ...
                        <div class="service-details">
                            ...
                            <div class="fade-gallery-wrapper">
                                <div class="fade-gallery-slider">
                                    <img src="{{ asset('storage/services/images/'.$service->image) }}" class="fade-gallery-img active" alt="gallery">
                                    @if($service->video)
                                    <img src="{{ asset('storage/services/images/'.$service->video) }}" class="fade-gallery-img" alt="gallery">
                                    @endif
                                </div>
                            </div>
                            @endif
                            <div class="service-summary">
                                <div class="info-left">
                                    ...
                                    <div class="price-time">Rs. {{ $service->price }} &nbsp; | &nbsp; <i class="far fa-clock"></i> {{ $service->duration }} mins</div>
                                    <div class="rating">
                            ...
                            <div class="tab-content py-5">
                                ...
                                <div class="tab-pane fade" id="how" role="tabpanel">
                                    <div class="row text-center">
                                        @foreach($service->how_it_works ?? [] as $step)
                                        <div class="col-md-6">
                                            <img src="{{ asset('storage/services/how_it_works/'.$step['image']) }}" alt="">
                                            <p>{{ $step['title'] }}</p>
                                        </div>
                                        @endforeach
                                    </div>
